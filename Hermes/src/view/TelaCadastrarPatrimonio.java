...
public class TelaCadastrarPatrimonio extends JPanel {
	...
	public TelaCadastrarPatrimonio() {
		...
		panelChamado.add(lblNewLabel_2, "cell 1 8,alignx left");
	...
	public JComboBox getCbBloco() {
		return cbBloco;
	}

	public void setCbBloco(JComboBox cbBloco) {
		this.cbBloco = cbBloco;
	}

	public JComboBox getCbAndar() {
		return cbAndar;
	}

	public void setCbAndar(JComboBox cbAndar) {
		this.cbAndar = cbAndar;
	}
	...
	public void carregarComBoxEspaco(List<Espaco> listarEspacos) {
